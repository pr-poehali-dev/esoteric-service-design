              ...
              <Card className="bg-gradient-to-br from-accent/20 via-mystic-purple/20 to-mystic-violet/20 border-accent/40 backdrop-blur-sm">
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap justify-center gap-4">
                    <Link to="/horoscope">
                      <Button size="lg" className="bg-gradient-to-r from-mystic-violet/30 to-mystic-violet/50 hover:opacity-90 text-white shadow-lg hover:shadow-xl transition-all">
                    ...
                    <Link to="/dreambook">
                      <Button size="lg" className="bg-gradient-to-r from-mystic-violet/50 to-mystic-purple/80 hover:opacity-90 text-white shadow-lg hover:shadow-xl transition-all">
